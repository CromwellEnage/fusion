...
namespace boost { namespace fusion
{
    ...
    struct front_extended_deque
      : ::boost::fusion::detail
        ::keyed_element<typename Deque::next_down, T, Deque>
      , ::boost::fusion
        ::sequence_base< ::boost::fusion::front_extended_deque<Deque, T> >
    {
        typedef ::boost::fusion::detail
        ::keyed_element<typename Deque::next_down, T, Deque> base;
        typedef ::boost::mpl::int_<(Deque::next_down::value - 1)> next_down;
