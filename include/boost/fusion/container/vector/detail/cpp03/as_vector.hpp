...
#define N BOOST_PP_ITERATION()
    ...
    struct as_vector<N>
    {
        ...
        static typename ::boost::fusion::detail::as_vector<N>
        ::template apply<Iterator>::type call(Iterator const& i0)
        {
            typedef typename ::boost::fusion::detail::as_vector<N>
...
BOOST_FUSION_BARRIER_BEGIN
    ...
    struct as_vector<0>
    {
        ...
        static typename ::boost::fusion::detail::as_vector<0>
...
#pragma wave option(preserve: 2, line: 0, output: "preprocessed/as_vector" \
...
#define BOOST_FUSION_NEXT_CALL_ITERATOR(z, n, data)                          \
    typename gen::BOOST_PP_CAT(I, BOOST_PP_INC(n))                           \
        BOOST_PP_CAT(i, BOOST_PP_INC(n)) = ::boost::fusion::next(            \
            BOOST_PP_CAT(i, n)                                               \
        );
