...
#undef TEXT
        {
            typedef ::boost::fusion::map<
                BOOST_PP_ENUM(N, BOOST_FUSION_PAIR, _)
            > type;
        };
    }
    ...
    inline ::boost::fusion::map<BOOST_PP_ENUM(N, BOOST_FUSION_PAIR, _)>
...
#pragma wave option(preserve: 2, line: 0, output: "preprocessed/make_map" \
    ...
    namespace result_of
    {
        template <
            BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
                FUSION_MAX_VECTOR_SIZE, typename K, ::boost::fusion::void_
            )
          , BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
                FUSION_MAX_VECTOR_SIZE, typename D, ::boost::fusion::void_
            )
...
#define BOOST_FUSION_PAIR(z, n, data)                                        \
    ::boost::fusion::pair<                                                   \
      ...
      , typename ::boost::fusion::detail                                     \
        ::as_fusion_element<BOOST_PP_CAT(D, n)>::type                        \
    >

#define BOOST_FUSION_MAKE_PAIR(z, n, _)                                      \
    ::boost::fusion::make_pair<BOOST_PP_CAT(K, n)>(BOOST_PP_CAT(_, n))
