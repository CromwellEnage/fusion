...
//
// OK, now can we replace all usage of std::forward to static_cast? -- I say
// NO!  All of rvalue-reference ready Clang doesn't compile above static_cast
// usage [2], sigh...
//
// References:
// 1. https://connect.microsoft.com/VisualStudio/feedback/details/1037806
//    /implicit-conversion-doesnt-perform-for-fund
...
// - MSVC 10.0 implements iterator intrinsics; MSVC 13.0 implements LWG2408.
    ...
    (BOOST_LIBSTDCXX_VERSION < 40500) && defined(BOOST_LIBSTDCXX11) \
