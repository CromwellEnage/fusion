...
namespace boost { namespace fusion
{
    ...
    struct transform_view_iterator :
        ::boost::fusion::iterator_base<
            ::boost::fusion::transform_view_iterator<First, F>
        >
    {
        typedef ::boost::fusion::transform_view_iterator_tag fusion_tag;
        typedef ::boost::fusion::convert_iterator<First> converter;
        typedef typename converter::type first_type;
        typedef typename ::boost::fusion::traits
        ::category_of<first_type>::type category;
    ...
    struct transform_view_iterator2 :
        ...
        >
    {
        typedef ::boost::fusion::transform_view_iterator2_tag fusion_tag;
        typedef ::boost::fusion::convert_iterator<First1> converter1;
        typedef ::boost::fusion::convert_iterator<First2> converter2;
        typedef typename converter1::type first1_type;
        typedef typename converter2::type first2_type;
        typedef typename ::boost::fusion::traits
        ::category_of<first1_type>::type category;
        typedef F transform_type;

        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        transform_view_iterator2(
            First1 const& in_first1
          , First2 const& in_first2
          , F const& in_f
        ) : first1(converter1::call(in_first1))
          , first2(converter2::call(in_first2))
          , f(in_f)
        {
        }
