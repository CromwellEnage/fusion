...
{
    template <>
    struct at_impl< ::boost::fusion::transform_view_tag>
    {
        ...
        struct apply
        {
            ...
            ::at<typename Seq::sequence_type, N>::type value_type;
    ...
    template <>
    struct at_impl< ::boost::fusion::transform_view2_tag>
    {
        template <typename Seq, typename N>
        struct apply
        {
            typedef typename Seq::transform_type F;
            typedef typename boost::fusion::result_of
            ::at<typename Seq::sequence1_type, N>::type value1_type;
            typedef typename boost::fusion::result_of
            ::at<typename Seq::sequence2_type, N>::type value2_type;
