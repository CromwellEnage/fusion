...
namespace boost { namespace fusion { namespace result_of
{
    ...
    {
        typedef ::boost::mpl
        ::vector_c<int, BOOST_PP_ENUM_PARAMS(N, I)> index_type;
        typedef ::boost::fusion::nview<Sequence, index_type> type;
    };
}}}
#endif
...
namespace boost { namespace fusion
{
    ...
    inline ::boost::fusion::nview<
        Sequence
      , ::boost::mpl::vector_c<int, BOOST_PP_ENUM_PARAMS(N, I)>
    >
    as_nview(Sequence& s)
    {
        typedef ::boost::mpl
        ::vector_c<int, BOOST_PP_ENUM_PARAMS(N, I)> index_type;
        return ::boost::fusion::nview<Sequence, index_type>(s);
    }
}}
