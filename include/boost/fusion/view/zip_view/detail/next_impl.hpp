...
namespace boost { namespace fusion { namespace detail
{
    struct poly_next
    {
        ...
        struct result< ::boost::fusion::detail::poly_next(It)>
        {
#if defined(BOOST_FUSION_USES_BOOST_VICE_CXX11_TYPE_TRAITS)
            ...
            typedef typename ::boost::mpl::eval_if<
              ...
              , ::boost::fusion::result_of::next<it>
            >::type type;
        };

        template <typename It>
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        typename ::boost::fusion::detail::poly_next::template result<
            ::boost::fusion::detail::poly_next(It)
        >::type
        operator()(It const& it) const
        {
            return ::boost::fusion::next(it);
        }
...
{
    template <>
    struct next_impl< ::boost::fusion::zip_view_iterator_tag>
    {
