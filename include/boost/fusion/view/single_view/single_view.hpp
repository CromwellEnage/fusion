...
namespace boost { namespace fusion
{
    template <typename T>
    struct single_view :
        ::boost::fusion::sequence_base< ::boost::fusion::single_view<T> >
    {
        typedef ::boost::fusion::single_view_tag fusion_tag;
        ...
        explicit single_view(
            typename ::boost::fusion::detail::call_param<T>::type in_val
        ) : val(in_val)
        {
        }
