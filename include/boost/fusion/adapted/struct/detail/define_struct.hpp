...
============================================================================*/
#if !defined(BOOST_FUSION_ADAPTED_DETAIL_STRUCT_DEFINE_STRUCT_HPP)
...
#define BOOST_FUSION_DEFINE_STRUCT_ASSIGN_OP(                                \
    ...
    BOOST_FUSION_GPU_ENABLED                                                 \
    self_type& operator=(Seq const& seq)                                     \
    {                                                                        \
...
#define BOOST_FUSION_DEFINE_STRUCT_ATTR_I(                                   \
    R, ATTRIBUTE_TUPLE_SIZE, ATTRIBUTE                                       \
)                                                                            \
...
#define BOOST_FUSION_DEFINE_STRUCT_CTOR_1(                                   \
    ...
    explicit NAME(                                                           \
        ...
        >::param_type arg                                                    \
            ...
            ATTRIBUTE_TUPLE_SIZE, 1, BOOST_PP_SEQ_HEAD(ATTRIBUTES_SEQ)       \
        )(arg)                                                               \
    {                                                                        \
    }
