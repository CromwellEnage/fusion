...
============================================================================*/
#if !defined(BOOST_FUSION_ADAPTED_STRUCT_DETAIL_ADAPT_BASE_HPP)
...
#define BOOST_FUSION_ADAPT_STRUCT_BASE_UNPACK_AND_CALL(                      \
    R, DATA, I, ATTRIBUTE                                                    \
)                                                                            \
...
#define BOOST_FUSION_ATTRIBUTE_TYPEOF(                                       \
    ...
    {                                                                        \
        static BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ) const& obj;   \
        typedef BOOST_PP_EXPR_IF(                                            \
            BOOST_FUSION_ADAPT_IS_TPL(TEMPLATE_PARAMS_SEQ)                   \
          , typename                                                         \
        ) BOOST_TYPEOF((                                                     \
            PREFIX() obj.BOOST_PP_TUPLE_ELEM(                                \
...
#define BOOST_FUSION_ATTRIBUTE_TYPEOF(                                       \
    ...
    {                                                                        \
        ...
        typedef BOOST_TYPEOF((                                               \
            PREFIX()                                                         \
            obj.BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPLE_SIZE, 0, ATTRIBUTE)      \
        )) type;                                                             \
    };                                                                       \
    typedef BOOST_PP_EXPR_IF(                                                \
        BOOST_FUSION_ADAPT_IS_TPL(TEMPLATE_PARAMS_SEQ)                       \
...
#else   // !defined(BOOST_NO_PARTIAL_SPECIALIZATION_IMPLICIT_DEFAULT_ARGS)
#define BOOST_FUSION_ADAPT_STRUCT_TAG_OF_SPECIALIZATION(                     \
    MODIFIER, TEMPLATE_PARAMS_SEQ, NAME_SEQ, TAG                             \
)                                                                            \
    template<                                                                \
...
#define BOOST_FUSION_ADAPT_STRUCT_C_BASE_IMPL(                               \
    TEMPLATE_PARAMS_SEQ, NAME_SEQ, IS_VIEW, I, PREFIX, ATTRIBUTE             \
  , ATTRIBUTE_TUPLE_SIZE, DEDUCE_TYPE, ADD_CONST, ADD_REF, IS_CONST          \
)                                                                            \
    template<                                                                \
        BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS(                    \
            TEMPLATE_PARAMS_SEQ                                              \
    ...
    {                                                                        \
        ...
        struct apply                                                         \
        {                                                                    \
            typedef typename ADD_REF<                                        \
                typename ::boost::mpl::eval_if<                              \
                    IS_CONST<Seq>                                            \
                  , ADD_CONST<attribute_type>                                \
                  , ::boost::mpl::identity<attribute_type>                   \
                >::type                                                      \
            >::type type;                                                    \
...
#define BOOST_FUSION_ADAPT_STRUCT_C_BASE(                                    \
  ...
  , ATTRIBUTE_TUPLE_SIZE, DEDUCE_TYPE                                        \
    ...
    BOOST_FUSION_ADAPT_STRUCT_C_BASE_IMPL(                                   \
        TEMPLATE_PARAMS_SEQ, NAME_SEQ, IS_VIEW, I, PREFIX, ATTRIBUTE         \
      , ATTRIBUTE_TUPLE_SIZE, DEDUCE_TYPE, ::boost::add_const                \
      , ::boost::add_lvalue_reference, ::boost::is_const                     \
    )
...
#define BOOST_FUSION_ADAPT_STRUCT_C_BASE(                                    \
  ...
  , ATTRIBUTE_TUPLE_SIZE, DEDUCE_TYPE                                        \
    ...
    BOOST_FUSION_ADAPT_STRUCT_C_BASE_IMPL(                                   \
        TEMPLATE_PARAMS_SEQ, NAME_SEQ, IS_VIEW, I, PREFIX, ATTRIBUTE         \
      , ATTRIBUTE_TUPLE_SIZE, DEDUCE_TYPE, ::std::add_const                  \
      , ::std::add_lvalue_reference, ::boost::is_const                       \
    )

#else   // C++11 Type Traits are sufficiently available.
...
#define BOOST_FUSION_ADAPT_STRUCT_C_BASE(                                    \
  ...
  , ATTRIBUTE_TUPLE_SIZE, DEDUCE_TYPE                                        \
    ...
    BOOST_FUSION_ADAPT_STRUCT_C_BASE_IMPL(                                   \
        TEMPLATE_PARAMS_SEQ, NAME_SEQ, IS_VIEW, I, PREFIX, ATTRIBUTE         \
      , ATTRIBUTE_TUPLE_SIZE, DEDUCE_TYPE, ::std::add_const                  \
      , ::std::add_lvalue_reference, ::std::is_const                         \
    )

#endif  // BOOST_FUSION_ADAPT_STRUCT_C_BASE
...
#define BOOST_FUSION_ADAPT_STRUCT_BASE(                                      \
    TEMPLATE_PARAMS_SEQ, NAME_SEQ, TAG, IS_VIEW, ATTRIBUTES_SEQ              \
  , ATTRIBUTES_CALLBACK                                                      \
)                                                                            \
...
{                                                                            \
    ...
    struct struct_size<BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ)> :    \
        ::boost::mpl::int_<BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(ATTRIBUTES_SEQ))>  \
    {                                                                        \
    };                                                                       \
    template <                                                               \
        BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS(                    \
    ...
    struct struct_is_view<                                                   \
        BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ)                      \
    > : ::boost::mpl::BOOST_PP_IIF(IS_VIEW, true_, false_)                   \
    {                                                                        \
    };                                                                       \
}}}                                                                          \
