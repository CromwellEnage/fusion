...
============================================================================*/
#if !defined(BOOST_FUSION_ADAPTED_STRUCT_DETAIL_ADAPT_BASE_ATTR_FILLER_HPP)
...
#define BOOST_FUSION_ADAPT_STRUCT_WRAP_ATTR(X, Y)                            \
    BOOST_PP_IIF(                                                            \
        BOOST_MPL_PP_TOKEN_EQUAL(auto, BOOST_PP_EXPAND(X))                   \
      , ((1, (Y)))                                                           \
      , ((2, (X, Y)))                                                        \
    )
...
#define BOOST_FUSION_ADAPT_STRUCT_ATTRIBUTES_FILLER_OP(r, unused, elem)      \
    BOOST_PP_IIF(                                                            \
      ...
      , BOOST_PP_EXPR_IIF(                                                   \
            BOOST_PP_COMPL(BOOST_PP_IS_EMPTY(elem))                          \
