...
namespace boost { namespace fusion { namespace detail
{
    ...
    struct segmented_fold_fun
    {
        ...
        explicit segmented_fold_fun(Fun const& f) : fun(f)
        {
        }
        ...
        struct apply
        {
            ...
            ::fold<Sequence, State, Fun>::type type;
            ...
            call(
              ...
              , Context const&
              , ::boost::fusion::detail
                ::segmented_fold_fun<Fun> const& fun
            )
            {
                return ::boost::fusion::fold(seq, state, fun.fun);
            }
        };
    };
    ...
    struct result_of_fold<Sequence, State, Fun, true, true>
    {
        typedef typename ::boost::fusion::result_of::segmented_fold_until<
            Sequence
          , State
          , ::boost::fusion::detail::segmented_fold_fun<Fun>
        >::type type;
        ...
        static type call(Sequence& seq, State& state, Fun& fun)
        {
            return ::boost::fusion::segmented_fold_until(
                seq
              , state
              , ::boost::fusion::detail::segmented_fold_fun<Fun>(fun)
            );
        }
    };
}}}
